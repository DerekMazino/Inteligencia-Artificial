...
emotions = ["miedo", "feliz", "neutral", "tristeza", "sorpresa", "enfado", "asco"] #lista de sentimientos
...
frame=cv2.imread('dataset/Cristian.jpg') #aqui se añade la imagen que quieres procesar pero aqui solo se carga para el resultado final
...
cv2.putText(frame, "Triste: {:.2f}".format(p4), (10, 120),
 cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
cv2.putText(frame, "Sorpresa: {:.2f}".format(p5), (10, 150),
 cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
cv2.putText(frame, "Enfado: {:.2f}".format(p6), (10, 180),
 cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
cv2.putText(frame, "Asco: {:.2f}".format(p7), (10, 210),
 cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
  

plt.imshow(frame)
plt.savefig("Cristian00")
plt.show()
# mostramos la imagen
